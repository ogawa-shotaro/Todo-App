...
import type { Todo, TodoInput } from "@/features/todos/types/type";
...
import { updateTodoAction } from "@/features/todos/stores/reducers/updateTodoReducer";
...
const CreateUpdateModal: React.FC<ModalProps> = ({
  todoItem,
  onCreateSuccess,
  onCancel,
}) => {
  ...
  const handleSubmit: FormEventHandler<HTMLFormElement> = async (event) => {
    ...
    const result = await dispatch(
      updateTodoAction({ id: todoItem?.id, ...formData })
    );
